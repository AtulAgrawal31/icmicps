<?php
    ...
    $email = $_POST['email'];
    $mobile = $_POST['mobile'];
    $sql = "INSERT INTO `guestform`(`firstname`, `middlename`, `lastname`, `affiliation`, `designation`, `amounttype`, `amount`, `paymenttype`,`datetime`, `country`, `state`, `transactionnumber`, `email`, `mobile`) VALUES ('$fname','$mname','$lname','$affiliation','$designation','$amounttype','$amount','$payment','$datetime','$country','$state','$UTR','$email','$mobile')";
    // echo $sql;
...
?>
        ...
        <section class="container mt-3 mb-3 pt-4 pb-4"  style="background-color:white; ">
            <div>
                <h4 class="style1 heading"><font font-weight:bold>Guest/Attendee/Listener Information</font></h4>
                <h4>&nbsp;</h4>
            </div>
			<form method="post">
                ...
                <div class="form-group"><label>Amount Type</label>
                    <select class="form-control" name="amounttype" id="" required>
                ...
                <div class="form-group"><label for="number">Transition Date & Transition Time</label>
                    <input class="form-control" type="datetime-local" name="datetime" placeholder="Date and Time" required>
                </div>
